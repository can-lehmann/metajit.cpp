...
class GenExtPlugin:
    def run(self, ir):
        ...
        struct += "  Symbol* build_guard_begin = nullptr;\n"
        struct += "  Symbol* build_guard_end = nullptr;\n"
        ...
        struct += f"    build_guard_begin = context.build_symbol(Type::Ptr, \"jitir_build_guard_begin\");\n"
        struct += f"    build_guard_end = context.build_symbol(Type::Ptr, \"jitir_build_guard_end\");\n"
